...
<body>
	...
	<div class="footer">
		Copyright &copy; 2017-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="http://bskeji.com" target="_blank">博世医信</a> ${fns:getConfig('version')}
	</div>
