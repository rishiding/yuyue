        ...
        <article data-scroll="true" id="login_article">
	        <div class="indented">
	            <form id="loginForm" action="${ctx}/login" method="post">
	            	...
	            	<div align="right">  <a href="#reg_section?test=abc" data-target="section" class="button  sun-flower" id="register">注册</a>
	            	&nbsp;&nbsp;
	            	<a href="#findpassword_section?test=abc" data-target="section" class="button  carrot" id="findpassword">忘记密码</a>&nbsp;&nbsp;</div>
	            	<div>&nbsp;</div>
