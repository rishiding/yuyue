...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	static SimpleDateFormat dft = null;
	...
	public static double getDistanceOfTwoSecs(Date before, Date after) {
		long beforeTime = before.getTime();
		long afterTime = after.getTime();
...
public static Date dateHelper(String format, String date) throws ParseException{ 
		
		return 	DateUtils.parseDate(date, format);
	}
	 
	public static Calendar getCalendarAtTime(String format, String date) throws ParseException{
		calendar.setTime(DateUtils.parseDate(date, format));
		return calendar;
	}
